...
public class NMSHorse {
     ...
     * 
     * @param clazz A class that extends net.minecraft.server.EntityHorse. <br>&nbsp;&nbsp;-&nbsp; Make sure you register the class with minecraft's EntityType handler first through the use of NMSHorse.<i>registerCustomHorseClass</i>(Class&lt;? extends EntityHorse>)
     * @param loc Location to spawn the horse at
     */
    ...
    public static boolean registerCustomHorseClass(Class<? extends EntityHorse> clazz) {
        try {
